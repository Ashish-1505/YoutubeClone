...
const CurrentUser = useSelector((state) => state.currentUserReducer);
  ...
  const uploadVideoFile = () => {
    if (!title) {
      ...
      fileData.append("Restriction",restrictions===""?"Public":restrictions);
    ...
    <div className="container_VidUpload">
      ...
      <div className="container2_VidUpload">
        <div className="ibox_div_vidupload">
          ...
          />
          <p className="ibox_vidupload">Video restriction:</p>
            <select className="select_box" onChange={(e)=>setRestrictions(e.target.value)}>
              <option className="option_box">Public</option>
              <option className="option_box">Only Subscribers</option>
            </select>
