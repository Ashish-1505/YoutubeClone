...
const API = axios.create({ baseURL: `https://youtubeclonebackend.onrender.com/` });
...
export const getOTP=(authData)=>API.post("/user/getotp",authData)
export const subscribe=(authData)=>API.post("/user/subscribe",authData)
export const unSubscribe=(authData)=>API.post("/user/unsubscribe",authData)
// export const checkSubscribe=(authData)=>API.get("/user/checkSubscribe",authData)
